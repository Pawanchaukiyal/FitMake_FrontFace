...
const App = () => {
  ...
  {/* done */}
  <Route path="/exerciselevel/:exerciselevel" element={<CommonUnifiedLevel />} />
  {/* done */}
  <Route path="/exerciseaot/:exerciseaot" element={<CommonUnifiedAot />} />

  <Route path="/yogaaot/:yogaaot" element={<CommonUnifiedAot />} />

{/* done */}
  <Route path="/combined/:value" element={<CommonPick />} /> {/* For combined data */}
